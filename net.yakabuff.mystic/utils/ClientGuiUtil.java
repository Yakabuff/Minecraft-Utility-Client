...
//	}
	...
	public static void drawString(String name, int x, int y, int col){
		setupOverlayRendering();
		disableDefaults();
//		GL11.glColor4f(1.0F, 0.75F, 0.0F, 1.0F);
		Mystic.mc.fontRenderer.drawString(name, x,y,col);
		enableDefaults();
	}
    ...
    public static void drawHLine(int x1, int y1, int width, int colour){
    	drawRect(x1, y1, x1+width, y1+1, colour);
    }
}
